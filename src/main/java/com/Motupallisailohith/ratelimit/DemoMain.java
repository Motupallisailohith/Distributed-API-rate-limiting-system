...
import com.Motupallisailohith.ratelimit.server.DemoHTTPServer;
...
/**
 * Demo version of Main.java that works without JWT dependencies
 */
public class DemoMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger.info("=== DISTRIBUTED RATE LIMITER DEMO ===");
        ...
        // 7. Demo HTTP server (without JWT dependencies)
